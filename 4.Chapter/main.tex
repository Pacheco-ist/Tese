...
\input{4.Chapter/1.Algorithm.tex}
\input{4.Chapter/2.BLE.tex}
\input{4.Chapter/3.LocationService.tex}
\input{4.Chapter/4.server.tex}
\input{4.Chapter/5.application.tex}
